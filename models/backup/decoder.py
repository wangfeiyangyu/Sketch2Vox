...
class Decoder(torch.nn.Module):
    def __init__(self, cfg):
        ...
        self.layer1 = torch.nn.Sequential(
            torch.nn.ConvTranspose3d(64, 512, kernel_size=4, stride=2, bias=cfg.NETWORK.TCONV_USE_BIAS, padding=1),
    ...
    def forward(self, image_features):
        ...
        for features in image_features:
            gen_volume = features.view(-1, 64, 2, 2, 2)
            # print(gen_volume.size())   # torch.Size([batch_size, 64, 2, 2, 2])
