...
from models.self_attention.vggEncoder import vggEncoder
from models.self_attention.pointnetEncoder import PointNetEncoder
from models.self_attention.decoder import Decoder
#from models.self_attention.decoder_7layer import Decoder
from models.self_attention.SAFusion import SAFusion
from models.self_attention.refiner import Refiner
...
def test_net(cfg):
    ...
    print('[DEBUG] %s Loading Parameters in SAfusion: %d.' % (dt.now(), utils.network_utils.count_parameters(fusion)))
